      ...
      <style>{`
        .pp-aurora {
          ...
          background:
            ...
            radial-gradient(45% 45% at 85% 25%, rgba(168,85,247,.14), transparent 60%),
            radial-gradient(60% 60% at 50% 85%, rgba(56,189,248,.10), transparent 65%);
        ...
        .pp-vignette {
          background:
            ...
            radial-gradient(95% 95% at 50% 50%, transparent, rgba(0,0,0,.76));
        }
