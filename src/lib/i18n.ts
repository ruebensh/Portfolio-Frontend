...
export const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    "certificates.title": "Sertifikatlarim",
    "resume.title": "Resume & Portfolio",
  ...
  en: {
    ...
    "home.defaultDesc": "Software engineer specializing in modern web technologies and AI.",
  ...
  ru: {
    ...
    "home.defaultDesc": "Разработчик, специализирующийся на современных веб-технологиях и ИИ.",
